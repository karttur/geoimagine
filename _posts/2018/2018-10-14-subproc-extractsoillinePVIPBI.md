...
excerpt: Soil lines are extracted either for scenes/tiles or regions around sample points
image: 
...
| source | process | seccomp | text | attribute | no | anyid |
| product | process | seccomp | text | attribute | no | anyid |
...
| suffix | process | seccomp | text | attribute | no | anyid |
