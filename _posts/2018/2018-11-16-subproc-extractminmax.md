...
date: 2018-11-16
modified: 2018-11-16
processurl: subproc-extractminmax
title: extractminmax
excerpt: No label set yet.
image: 
rootprocid: TimeSeries
subprocid: extractminmax
...
<process>
  ...
  <parameters max="True/False" min="True/False" version="txtstring"/>
...
| min | process | parameters | boolean | attribute | no | True |
| max | process | parameters | boolean | attribute | no | True |
