...
The process <span class='package'>resampletssmap</span> can be used for any temporal resampling of SMAP data. To resample to 16 day intervals, with 8 day jumps, the following parameterization:
