...
date: 2019-04-23
modified: 2019-04-23
processurl: subproc-AspectModis
title: AspectModis
excerpt: No label set yet.
image: 
rootprocid: DEM
subprocid: AspectModis
...
<process>
  ...
  <parameters ZevenbergenThorne="True/False" compute_edges="True/False" copycomp="txtstring" mosaic="True/False" trigonometric="True/False" version="txtstring" zero_for_flat="True/False"/>
...
| trigonometric | process | parameters | boolean | attribute | no | --- |
| zero_for_flat | process | parameters | boolean | attribute | no | True |
| copycomp | process | parameters | text | attribute | no | aspect |
