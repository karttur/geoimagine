...
date: 2019-04-23
modified: 2019-04-23
processurl: subproc-autocorrelateancillary
title: autocorrelateancillary
excerpt: No label set yet.
image: 
rootprocid: TimeSeries
subprocid: autocorrelateancillary
...
<process>
  ...
  <parameters copycomp="txtstring" mirror="xyz" nlags="xyz" partial="True/False" resampleseasonal="True/False" version="txtstring"/>
...
| nlags | process | parameters | integer | attribute | no | Y |
...
| copycomp | process | parameters | text | attribute | no | autocorr |
