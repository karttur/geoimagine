...
<process>
  ...
  <parameters asscript="True/False" copycomp="txtstring" emboss="txtstring" embossdims="txtstring" embossptsize="xyz" framecrop="txtstring" framewidth="xyz" htile="xyz" timelayout="txtstring" vtile="xyz"/>
...
| timelayout | process | parameters | text | attribute | no | default |
| framewidth | process | parameters | integer | attribute | yes | --- |
| framecrop | process | parameters | text | attribute | yes | --- |
