...
date: 2019-04-23
modified: 2019-04-23
processurl: subproc-roughnessModis
title: roughnessModis
excerpt: No label set yet.
image: 
rootprocid: DEM
subprocid: roughnessModis
...
<process>
  ...
  <parameters compute_edges="True/False" copycomp="txtstring" mosaic="True/False" resolid0="xyz" version="txtstring"/>
...
| resolid0 | process | parameters | integer | attribute | yes | --- |
| copycomp | process | parameters | text | attribute | no | roughness |
...
| id | process | resolfac | integer | attribute | yes | --- |
