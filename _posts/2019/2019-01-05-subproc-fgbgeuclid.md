...
date: 2019-01-05
modified: 2019-01-05
processurl: subproc-fgbgeuclid
title: fgbgeuclid
excerpt: Foreground background indexing using euclidean distances
image: 
rootprocid: Image
subprocid: fgbgeuclid
...
<process>
  ...
  <parameters bgfactor="xyz" feature="xyz" maxindex="xyz" version="txtstring"/>
...
| bgfactor | process | parameters | integer | attribute | yes | 0 |
| feature | process | parameters | integer | attribute | no | 0 |
| maxindex | process | parameters | integer | attribute | no | 0 |
